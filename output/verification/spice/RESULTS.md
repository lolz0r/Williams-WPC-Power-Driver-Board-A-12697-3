...
| measurement | value | expected | result |
|---|---|---|---|
| coil current while BLANKING is high (reset, +5V ramp, undefined latch content = 1) (A): the tri-stated 74HCT574 and the 10 k gate pull-down keep the IRLR3110Z off (`icoil_blank`) | 1.386e-08 | 0 … 0.01 | PASS |
...
| solenoid gate voltage while blanked (V) (`vgate_blank`) | 0.0001636 | 0 … 0.5 | PASS |
...
| coil current after the CPU writes 0 (A) (`icoil_after`) | 2.6e-09 | 0 … 0.01 | PASS |
| column current after the CPU writes 0 (A) (`icol_after`) | 0.000105 | 0 … 0.01 | PASS |
...
| coil current 15 ms after turn-off (A) (`icoil_off`) | 2.445e-08 | -0.01 … 0.05 | PASS |
