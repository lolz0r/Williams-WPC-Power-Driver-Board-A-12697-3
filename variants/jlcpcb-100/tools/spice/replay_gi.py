...
ng=NgSpice();cases=[]
base=(HERE/'decks/gi_string.cir').read_text().replace('QMMBT4401','J100Q2222').replace('/ 0.025','/ 0.05').replace('BTA16','BTA08')
...
'''
  ...
  limits={'sim_end':(duration-1e-7,duration+1e-7),'peak_current':(0,80),'rms_current':(0,5),'inrush_i2t':(0,32),'tj':(0,125)}
