"""JLC-100 power-supply component and connectivity specification.
...
RAILS = [
    dict(ref='U20', vin='/Power_Supply/+5V_RAW', out='+5V', center=(269., 58.),
         ...
         shunt_code='C705606', shunt_ohm=.013, fb_code='C865625', fb_ohm=6650., rc_code='C37252', rc_ohm=33000.,
...
def components(rail, originals):
    ...
    part(u,u,icnets,'TPS552892RYQR','C19272254',IC_FOOTPRINT,
         '36 V synchronous buck-boost; PFM; internal VCC; output current limit; JLC-100')
