...
class NgSpice:
    def __init__(self, path=None):
        ...
        self.log = []
        self._cb = [SendChar(self._send_char), SendStat(), ControllerExit(self._exit),
                    SendData(), SendInitData(), BGThreadRunning(self._bg)]
        ...
        if not model_dir and os.path.isdir('/app/lib/ngspice'):
            model_dir = '/app/lib/ngspice'
        if model_dir:
