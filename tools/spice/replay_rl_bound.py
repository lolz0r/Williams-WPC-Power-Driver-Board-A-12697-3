...
def main():
 results=[]
 for folder,trace in [('replay-diagnostics',ROOT/'output/verification/mame/diagnostics/bus.csv'),('replay-gameplay',ROOT/'output/verification/pinmame/gameplay/bus.csv')]:
  report=json.loads((REV/folder/'results.json').read_text());assert report['passed']
